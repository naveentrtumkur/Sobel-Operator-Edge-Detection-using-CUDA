...
printf("seconds\n");
printf("Number of GFlops taken for computation:%d flops",(dimA*dimA)/(1*tpb*nblocks)); 
printf("\n**************************************************\n");
...
size_t differ = CompareArrays(h_b, h_c, dimA * dimA, Threshold);
if(0 == differ)
{
